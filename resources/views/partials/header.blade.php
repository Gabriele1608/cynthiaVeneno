<header
class="z-40 fixed w-full md:px-16 flex flex-wrap items-center md:py-0 py-2 opacity-50 xs:opacity-75 bg-black">
<div class="flex-1 mr-2 flex justify-center items-center lg:justify-start">
  ...
  <a href="{{route('welcome')}}" class="text-2xl font-semibold hover:font-bold hover:text-purple-600 ml-2 text-white ">Cynthia VeNeNo</a>
</div>

<label for="menu-toggle" class="pointer-cursor mr-4 md:hidden block"><svg class="fill-current text-white"
...
<div class="bg-black hidden md:flex md:items-center md:w-auto w-full mx-auto" id="menu">
  <nav class="">
    <ul class="ml-4 md:ml-0 md:flex items-center justify-between text-purple-700 md:text-white pt-4 md:pt-0 hover:text-opacity-100">
      ...
      <li><a class="md:p-4 py-3 px-0 block border-b-2 border-transparent hover:font-semibold hover:text-purple-400 md:hover:border-white"
          href="#works">Trabajos</a></li>
     <li><a class="md:p-4 py-3 px-0 block border-b-2 border-transparent hover:font-semibold hover:text-purple-400 md:hover:border-white"
            href="#biografia">Biografía</a>
        </li>
      ...
      @if(Route::has('login'))
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-content md:absolute hidden text-start pr-4 ">
            <li><a class=" hover:font-bold hover:text-purple-500 py-2 px-2 block whitespace-no-wrap text-white"
